...
import { getAnalysisForTranscript, transcribeAudioFile } from '../services/geminiService.ts';
import type { AnalysisResult, TranscriptLine } from '../types.ts';
import { MicrophoneIcon, StopIcon, RefreshIcon, SparklesIcon, DownloadIcon } from './icons.tsx';
