...
import type { CoachingTip, AnalysisResult } from '../types.ts';
import { SparklesIcon, SpeakerWaveIcon, PlayIcon } from './icons.tsx';
import { getTextToSpeech } from '../services/geminiService.ts';
import { playAudioFromBase64 } from '../utils/audio.ts';
